(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-editor/helpers', ['exports', 'prosemirror-inputrules'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ngx-editor"] = global["ngx-editor"] || {}, global["ngx-editor"].helpers = {}), global.prosemirrorInputrules));
    ...
    ***************************************************************************** */
    ...
    var markInputRule = function (regexp, markType, attrs) {
        return new prosemirrorInputrules.InputRule(regexp, function (state, match, start, end) {
            var tr = state.tr;
            if (match[2]) {
                var textStart = start + match[0].indexOf(match[2]);
